...
class ValidateJsonApiHeadersTest extends TestCase
{
    ...
    /** @test  */
    public function content_type_must_be_present_in_all_post_requests()
    {
    ...
    /** @test  */
    public function content_type_must_be_present_in_all_patch_requests()
    {
    ...
    /** @test  */
    public function content_type_must_be_present_in_all_responses()
    {
        $this->get('test_route', [
            'accept' => 'application/vnd.api+json'
